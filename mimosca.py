...
## progress bar
# this function is used to display a progress bar during some function executions
...
#######read input############
# this function reads in expression data from a file at the specified path
# the function reads in the matrix using the scipy.io.mread() function, which reads the Matrix market format which is commonly used to represent sparse matrices
# in a sparse matrix, only a small % of elements have non-zero values
def read_10x(pathin):
